use utf8;
package Pantry::Schema::Result::Storage;
...
__PACKAGE__->has_many(
  ...
  { "foreign.storage_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07042 @ 2016-07-19 13:02:35
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gwKbVyz7NLjxDXVblkooXA
